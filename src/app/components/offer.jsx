...
const offer = () => {
  return (
    <div id= 'offer' className='w-full h-screen bg-[#FFBF69]'>
        <div className='max-w-[1240px] m-auto px-2 py-10 w-full'>

<p className='text-center text-4xl lg:text-5xl tracking-wide uppercase mt-6 mb-6 text-black'>
     What We Offer
</p>



<div className='grid lg:grid-cols-2 gap-10 lg:gap-16 p-10'>


{/* left */}
<div className='col-span-3 lg:col-span-1 w-full shadow-xl bg-white shadow-gray-400 rounded-xl px-2 py-8 lg:px-10 lg:py-24'>
